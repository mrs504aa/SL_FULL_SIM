...
function steadystate_fourier_2d(
    ...
    H_p12::QuantumObject{OpType4},
    H_m12::QuantumObject{OpType5},
    ωd1::Number,
    ωd2::Number,
    ...
    L_p12 = liouvillian(H_p12)
    L_m12 = liouvillian(H_m12)
    return _steadystate_fourier_2d(L_0, L_p1, L_m1, L_p12, L_m12, ωd1, ωd2; n_max1=n_max1, n_max2=n_max2, tol=tol, kwargs...)
end
...
function _steadystate_fourier_2d(
    ...
    L_p12::QuantumObject{SuperOperator},
    L_m12::QuantumObject{SuperOperator},
    ωd1::Number,
    ωd2::Number;
    n_max1::Integer=1,
    n_max2::Integer=1,
    ...
    L_p12_mat = get_data(L_p12)
    L_m12_mat = get_data(L_m12)
